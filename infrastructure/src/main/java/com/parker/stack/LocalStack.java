package com.parker.stack;

import com.parker.stack.constants.LocalStackConstants;
...
public class LocalStack extends Stack {
    private static final Logger LOGGER = Logger.getLogger(LocalStack.class.getName());
    ...
    public LocalStack(final App app, final String id, final StackProps props) {
        ...
        CfnCluster mskCluster = createCfnCluster();
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "lKfBLcy5NchjcFbyTtHREy+IAKa3X5pdRYd9BpFUrmQCzRcyR8U9ZVLqdUu5YfAz"));
    ...
    private Cluster createEcsCluster() {
        return Cluster.Builder
                ...
                .vpc(vpc)
                .defaultCloudMapNamespace(CloudMapNamespaceOptions.builder()// does service discovery
    ...
    private CfnHealthCheck createCfnHealthCheck(DatabaseInstance databaseInstance, String id) {
    ...
    private FargateService createFargateService(String id,
        ...
        if (databaseInstance != null) {
            ...
            envVars.put("SPRING_DATASOURCE_PASSWORD",
                    Objects.requireNonNull(databaseInstance.getSecret(), "Password cannot be null").secretValueFromJson("password").toString());
    ...
    private void createApiGatewayService() {
        ...
        ContainerDefinitionOptions containerOptions =
                ContainerDefinitionOptions.builder()
                        .image(ContainerImage.fromRegistry(LocalStackConstants.API_GATEWAY.getValue()))
                        .environment(Map.of(
                        ...
                        .logging(LogDriver.awsLogs(AwsLogDriverProps.builder()
                                .logGroup(LogGroup.Builder.create(this, "ApiGatewayLogGroup")
                                        ...
                                        .retention(RetentionDays.ONE_DAY)
                                        .build())
                                .streamPrefix(LocalStackConstants.API_GATEWAY.getValue())
                                .build()))
                        .build();
    ...
    public static void main(String[] args) {
        ...
        app.synth();
        LOGGER.info("App synthesizing in progress...");
    }
}
