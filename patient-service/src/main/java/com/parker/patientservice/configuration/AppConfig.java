...
public class AppConfig {
    ...
    public ModelMapper modelMapper() {
        ...
        Converter<String, LocalDate> toLocalDate = ctx -> ctx.getSource() == null ? null : LocalDate.parse(ctx.getSource());
        mapper.typeMap(PatientRequestDTO.class, Patient.class)
                .addMappings(m -> m.using(toLocalDate).map(PatientRequestDTO::getDateOfBirth, Patient::setDateOfBirth));
